...
var sprChestPlain = resources.addSprite("graphics/sprChestPlain.png", 1, 64, 48, 32, 24, 0);
...
function initObjectTypes(){
    ...
    x = addObjectType("ChestPlain", false, false, sprChestPlain, ChestPlain);
